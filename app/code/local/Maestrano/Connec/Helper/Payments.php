...
class Maestrano_Connec_Helper_Payments extends Maestrano_Connec_Helper_BaseMappers {
    ...
    private $payment_method_mapping_reverse = null;
    ...
    public function __construct() {
        ...
        $this->payment_method_mapping_reverse = array('ccsave' => 'CC', 'checkmo' => 'ORD');
    }
    ...
    protected function mapModelToConnecResource($payment)
    {
        ...
        $payment_method = $this->payment_method_mapping_reverse[$payment->getMethod()];
        if(is_null($payment_method)) {
          if (preg_match('/paypal/', $payment->getMethod())) { $payment_method = 'PAYPAL'; }
          else { $payment_method = 'O'; }
        }
